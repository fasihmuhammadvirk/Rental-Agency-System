...
class Customer:
    ...
    def main(self):
        ...
        tk.Label(root,bg='linen', text="Customer Information", fg="red", font=(None, 30)).place(x=400, y=20)
         
        tk.Label(root,bg='linen', text="Customer Name").place(x=10, y=10)
        ...
        e2.place(x=140, y=40)
        e2.config(validate="key", validatecommand=(regs,'%S'))
        ...
        Button(root,highlightbackground = 'linen', text="Add",command = self.Customer_information,height=2, width= 13).place(x=10, y=190)
    ...
    def Customer_information(self):
        ...
        messagebox.showinfo("information", "Customer Information Inserted successfully...")
    ...
    def delete(self):
        ...
        try:
           sql = "DELETE customer_information where cnic = '{}';".format(cnic)
           cur = con.cursor()
           cur.execute(sql)
           con.commit()
           lastid = cur.lastrowid
    ...
    def update(self):
        ...
        messagebox.showinfo("information", "Customer Information Updated successfully...")
    ...
    def GetValue(self,event):
        ...
        e1.insert(0,select['Customer Information'])
    ...
    def show(self):
            ...
            cur = con.cursor()
            cur.execute("SELECT * from customer_information")
            records = cur.fetchall()
            print(records)
     
            for i, (customer_name ,father_name ,contact_information ,age ,date_of_birth ,cnic ) in enumerate(records, start=1):
                self.listBox.insert("", "end", values=(customer_name ,father_name ,contact_information ,age ,date_of_birth ,cnic))
                #con.close()    
